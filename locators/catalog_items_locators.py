...
class CatalogItemsLocators:
    ...
    PRODUCT_SUCCESS_ADDED_CART = (By.CLASS_NAME,
                                  ".layer_cart_product > h2")
    # or //*[@class="icon-ok"] #text
    PROCEED_TO_CHECKOUT_BUTTON_ITEM = (
    By.XPATH, "//*[@class='button-container']/a/span")
    PROCEED_TO_CHECKOUT_BUTTON_IN_CART_SUMMARY = (
    By.XPATH, "//*[@id='center_column']/p[2]/a[1]")
    PROCEED_TO_CHECKOUT_BUTTON_IN_CART_ADDRESS = (
    By.XPATH, "//*[@id='center_column']/form/p/button")
    CHECKBOX_I_AGREE_IN_CART_SHIPPING = (By.XPATH, "//*[@id='cgv']")
    PROCEED_TO_CHECKOUT_BUTTON_IN_CART_SHIPPING = (
    By.XPATH, "//*[@name='processCarrier']")
    PAY_BY_BANK_WIRE_BUTTON = (By.XPATH, "//*[@class='bankwire']")
    I_CONFIRM_MY_ORDER_BUTTON = (
